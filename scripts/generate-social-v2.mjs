...
const sponsorStrip = `<div class="sponsor-strip"><img src="${artisanLogo}" alt="Artisan Education"></div>`;
...
.sponsor-strip{position:absolute;right:42px;bottom:38px;z-index:12;width:230px;height:86px;border-left:1px solid #bcf75a55;padding-left:22px;display:flex;flex-direction:column;align-items:flex-start;justify-content:center;gap:10px}.sponsor-strip:before{content:'GENERAL PARTNER';color:#bcf75a;font:800 10px monospace;letter-spacing:2.4px;text-transform:uppercase}.sponsor-strip img{max-width:185px;max-height:42px;object-fit:contain;filter:brightness(0) invert(1);opacity:.98}.cards{position:relative;margin-top:32px;display:grid;grid-template-columns:1fr 1fr;gap:18px;z-index:7}.card{height:305px;border:1px solid #354332;background:#10150f;padding:28px;display:flex;flex-direction:column;justify-content:space-between}.card.active{border-color:#bcf75a;box-shadow:0 0 0 1px #bcf75a inset}.card .icon{color:#bcf75a;font-size:66px;line-height:1}.card h2{font-size:32px;line-height:1.03;margin:0;letter-spacing:-1.8px;text-transform:uppercase}.card h2.long{font-size:27px;line-height:1.06}.card p{font-size:16px;line-height:1.45;margin:10px 0 0}
