...
.vote-final{display:grid;place-items:center;text-align:center}.vote-final h1{font-size:66px;line-height:.88;letter-spacing:-4px;margin:0;max-width:650px}.vote-final .vote-word{color:#bcf75a}.vote-final p{margin-left:auto;margin-right:auto;max-width:720px}.vote-ring{position:absolute;left:50%;top:50%;width:760px;height:760px;margin:-380px 0 0 -380px;border:1px dashed #bcf75a44;border-radius:50%;z-index:1}.vote-ring:before,.vote-ring:after{content:"";position:absolute;inset:74px;border:1px solid #2e3c2a;border-radius:50%}.vote-ring:after{inset:148px;border-color:#bcf75a33}.vote-person{position:absolute;right:-82px;bottom:-18px;width:450px;height:auto;z-index:3;filter:drop-shadow(-28px 0 42px #000b)}.vote-copy{position:absolute!important;left:58px;right:365px;bottom:220px;z-index:9;text-align:left;display:block}.vote-final>.brand,.vote-final>.topline{position:relative;z-index:10}.vote-final>.ticker{z-index:8}
`;
