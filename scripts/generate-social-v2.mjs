...
const artisanLogo = '../../public/partners/artisan-education.svg';
...
const sponsorStrip = `<div class="sponsor-strip"><span>GENERAL PARTNER</span><div><img src="${artisanLogo}" alt="Artisan Education"><b>ARTISAN EDUCATION</b></div></div>`;
...
.sponsor-strip{position:absolute;right:30px;bottom:44px;z-index:12;width:260px;height:92px;border-left:1px solid #bcf75a55;padding-left:22px;display:flex;flex-direction:column;align-items:flex-start;justify-content:center;gap:10px}.sponsor-strip span{color:#bcf75a;font:800 10px monospace;letter-spacing:2.4px;text-transform:uppercase}.sponsor-strip div{display:flex;align-items:center;gap:13px}.sponsor-strip img{width:42px;height:42px;object-fit:contain;filter:brightness(0) invert(1);opacity:.98}.sponsor-strip b{color:#f0f2eb;font:900 16px/1 Arial,Helvetica,sans-serif;letter-spacing:.5px;text-transform:uppercase;max-width:170px}.cards{position:relative;margin-top:32px;display:grid;grid-template-columns:1fr 1fr;gap:18px;z-index:7}.card{height:305px;border:1px solid #354332;background:#10150f;padding:28px;display:flex;flex-direction:column;justify-content:space-between}.card.active{border-color:#bcf75a;box-shadow:0 0 0 1px #bcf75a inset}.card .icon{color:#bcf75a;font-size:66px;line-height:1}.card h2{font-size:32px;line-height:1.03;margin:0;letter-spacing:-1.8px;text-transform:uppercase}.card h2.long{font-size:27px;line-height:1.06}.card p{font-size:16px;line-height:1.45;margin:10px 0 0}
...
.vote-final{display:grid;place-items:center;text-align:center}.vote-final h1{font-size:64px;line-height:.88;letter-spacing:-4px;margin:0 auto;max-width:900px;text-align:center}.vote-final .vote-word{color:#bcf75a}.vote-final p{margin-left:auto;margin-right:auto;max-width:720px}.vote-ring{position:absolute;left:50%;top:50%;width:760px;height:760px;margin:-380px 0 0 -380px;border:1px dashed #bcf75a44;border-radius:50%;z-index:1}.vote-ring:before,.vote-ring:after{content:"";position:absolute;inset:74px;border:1px solid #2e3c2a;border-radius:50%}.vote-ring:after{inset:148px;border-color:#bcf75a33}.vote-person{position:absolute;left:50%;bottom:-165px;width:700px;height:auto;transform:translateX(-50%);z-index:3;filter:drop-shadow(0 0 58px #000d)}.vote-copy{position:absolute!important;left:58px;right:58px;top:165px;z-index:9;text-align:center;display:block}.vote-final>.brand,.vote-final>.topline{position:relative;z-index:10}.vote-final>.ticker{z-index:8}
`;
...
const slides = [
  ...
  ...partnerSlides.map(([n, title, name, desc, partnerLogo], i) =>
    frame(`partners-${String(i + 2).padStart(2, '0')}`, 'partners', i + 2, {
      className: 'xl',
      html: `<img class="brand" src="${logo}" alt=""><div class="topline">ПАРТНЁРЫ<br>${n}</div><div class="kicker"><b>${n}</b>DIGITAL NIS FORUM</div><h1>${title}</h1><article class="partner-frame"><img class="partner-logo-img" src="${partnerLogo}" alt="${name}"><div><h2>${name}</h2><p>${desc}</p></div><span class="num">${n}</span></article><div class="footer"><span>Спасибо за поддержку</span><span>${String(i + 2).padStart(2, '0')} / 04</span></div>`,
    }),
  ),
