...
const competitions = [
  ...
  ['02', 'NIS Edutech Hackathon', 'Реальные задачи и технологические решения для обучения.', '⌘'],
  ['03', 'Jas Startuper', 'Площадка для молодых авторов проектов.', '✳'],
  ['04', 'FIFA League', 'Покажи навык и поборись за финал.', '⊕'],
];
...
const aptaEvents = [
  ...
  ['15.09', 'Vibe Coding', 'Кодинг с ИИ, быстрый прототип и путь от идеи к MVP для команд хакатона.', '03'],
  ['15.09', 'Коммерциализация стартапа', 'Проблема клиента, ценность продукта, монетизация и первые клиенты.', '04'],
  ['16.09', 'Презентация и питчинг', 'Структура презентации, история проекта, тайминг и ответы жюри.', '05'],
  ['17.09', '3D-моделирование и печать', 'Практический воркшоп: моделирование, слайсинг и печать.', '06'],
  ['17.09', 'Объявление финалистов', 'Команды и участники четырёх соревнований будут объявлены онлайн.', '07'],
  ['18.09', 'Пробный питчинг', 'Репетиция выступления и экспертная обратная связь перед форумом.', '08'],
];
...
.brand{position:absolute;left:58px;top:58px;width:176px}
.topline{position:absolute;right:58px;top:68px;color:#9ca692;font:13px/1.5 monospace;letter-spacing:4px;text-align:right;text-transform:uppercase}
.kicker{position:relative;margin-top:118px;color:#9ba594;font:14px monospace;letter-spacing:4px;text-transform:uppercase}
.kicker b{color:#bcf75a;margin-right:13px}
h1{position:relative;margin:42px 0 0;font-size:86px;line-height:.93;letter-spacing:-5px;font-weight:800;max-width:930px}
.huge h1{font-size:126px;letter-spacing:-8px}.xl h1{font-size:104px}
p{position:relative;color:#a9b0a6;font-size:27px;line-height:1.42;margin:24px 0 0;max-width:820px}.lime{color:#bcf75a}
...
.event-card{position:relative;margin-top:62px;height:610px;border:1px solid #354332;background:#10150f;padding:42px;display:flex;flex-direction:column;justify-content:space-between}.event-card .day{font-size:108px;letter-spacing:-7px;font-weight:800;color:#bcf75a}.event-card h2{font-size:58px;line-height:1.02;letter-spacing:-3px;margin:0;text-transform:uppercase}.event-card p{font-size:25px}.event-card .num{position:absolute;right:34px;bottom:20px;font-size:185px;font-weight:800;color:#bcf75a16;letter-spacing:-12px}
