...
const artisanBadge = `<div class="artisan-badge"><span>GENERAL PARTNER</span><div><img src="${artisanLogo}" alt="Artisan Education"><b>ARTISAN EDUCATION</b></div></div>`;

const workshops = [
  ['01', '14.09', 'Startup + Pitching', 'Стартап-мышление, сильная идея, структура питча и уверенная презентация проекта.', '↗'],
  ['02', '17.09', 'Artisan 3D Modeling', 'Практический мастер-класс от Artisan Education: 3D-моделирование, форма, идея и цифровой объект.', '3D'],
];
