...
const workshops = [
  ...
  ['02', '15.09', 'Vibe Coding', 'Кодинг с ИИ, быстрый прототип и путь от идеи к MVP для команд хакатона.', '⌘'],
  ['03', '15.09', 'Коммерциализация стартапа', 'Проблема клиента, ценность продукта, монетизация и первые клиенты.', '₸'],
  ['04', '16.09', 'Artisan 3D Modeling', 'Практический мастер-класс по 3D-моделированию: от формы и идеи до цифрового объекта.', '3D'],
  ['05', '17.09', 'Mock Day', 'Пробный день для команд хакатона и Startup Battle: прогон решений, питчей и обратная связь.', '✳'],
];
