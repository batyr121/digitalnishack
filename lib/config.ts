...
export const events: EventRecord[] = [
  ...
  },
  {
    ...
    title: 'Vibe Coding',
    description: 'Кодинг с ИИ, быстрый прототип и путь от идеи к MVP для команд хакатона.',
    day: 15,
    time: 'TBA',
    track: 'ХАКАТОН',
  ...
  },
  {
    ...
    title: 'Коммерциализация стартапа',
    description:
      'Проблема клиента, ценность продукта, монетизация и первые клиенты.',
    day: 15,
    time: 'TBA',
    track: 'СТАРТАПЫ',
    location: 'Место скоро объявим',
  ...
  },
  {
    ...
    description: 'Знакомство с выбранными командами и участниками четырёх соревнований.',
    day: 17,
    time: 'TBA',
    track: 'DIGITAL APTA',
    location: 'Онлайн',
  ...
  },
  {
    ...
    description:
      'Финальные раунды и главный матч. Правила и время скоро объявим.',
    day: 19,
    time: 'TBA',
    track: 'ИГРЫ',
...
export const competitions = [
  ...
  },
  {
    slug: 'jas-startuper',
    title: 'JAS STARTUPER',
    tag: 'БОЛЬШИЕ ИДЕИ НАЧИНАЮТСЯ РАНО.',
    description: 'Площадка для молодых авторов проектов.',
    slots: 0,
    icon: '✳',
  },
  {
    slug: 'fifa',
    title: 'FIFA LEAGUE',
    tag: 'ТВОЯ ИГРА. ТВОЙ МОМЕНТ.',
    description: 'Покажи навык и поборись за финал.',
    slots: 0,
    icon: '⊕',
  },
];
